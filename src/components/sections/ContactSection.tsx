    ...
    >
      <Container className="contact-page">
        ...
        <div className="contact-workspace">
          <RevealGroup className="contact-lead" mode="auto" stagger={50}>
          ...
          <div className="contact-aside">
            <RevealGroup className="contact-log" mode="auto" stagger={45}>
              <Reveal type="nav">
            ...
            <div className="contact-channels">
              <Reveal type="heading" as="h3">
                <TypeCopy text={t.contact.selectChannel} />
              </Reveal>
              <RevealGroup as="ul" mode="scroll" stagger={45}>
                {CONTACT_OPTIONS.map((option, index) => {
                  const copy = optionCopy(t.contact.options, option.id)

                  return (
                  <Reveal key={option.id} as="li" type="left">
                    <a
